...
namespace MySchoolDiaryProject.Data.Migrations
{
    ...
    [Migration("20200506161327_DeletableModels")]
    partial class DeletableModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MySchoolDiaryProject.Data.Models.Student", b =>
                {
                    ...
                    b.Property<string>("DateOfFirstDayInSchool")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MySchoolDiaryProject.Data.Models.Grade", b =>
                {
                    b.HasOne("MySchoolDiaryProject.Data.Models.Subject", null)
                        .WithMany("Grades")
                        .HasForeignKey("SubjectId");
                });
            ...
            modelBuilder.Entity("MySchoolDiaryProject.Data.Models.Student", b =>
                {
                    b.HasOne("MySchoolDiaryProject.Data.Models.Course", "Courses")
                        .WithMany("Students")
                        .HasForeignKey("CourseId");
                });
